...
import { getPackageById, getTeacherById } from "../DefaultHome.service";

import { ToastFailedMsg, ToastSuccessMsg, ToastWarningMsg } from "../../common/toast";
import { useParams, useHistory } from "react-router-dom";
import { getTeacherPostsByUserId, getTeacherPostsWiseUserById } from "./TeacherPosts.service";
import BottomNav from "../../common/BottomNav.page";
import Footer from "../../common/Footer.page";


export default function TeacherNeedDetailsPage({ handleClose }: any): ReactElement {
    ...
    const loadTeacherDetails = async (id: any) => {
        ...
        let res = await getTeacherPostsWiseUserById(id)
        if (res.status === 200 || res.status === 201) {
            let data = await res.json()
                                ...
                                <Row>
                                    ...
                                    <Col sm={2} md={9} lg={12}>
                                        ...
                                        <Row className="d-flex justify-content-between  text-capitalize mt-1">
                                            ...
                                            <Col><strong className="text-info">Qualification:</strong> <span className="text-danger"> {teacherPosts.qualification}  </span></Col>
                                        </Row>
                                        ...
                                        <Row className="d-flex  justify-content-between text-capitalize mt-1">
                                            ...
                                            <Col> <span className="text-capitalize"><strong className="text-success ">Designation: </strong> <span className="text-danger">{teacherPosts?.designation}</span></span></Col>
                                        </Row>
                                        ...
                                        <Row className="d-flex  justify-content-between text-capitalize mt-1">
                                            <Col> <strong className="text-info">Area You Coverd:</strong> {teacherPosts.area_covered}</Col>
                                        </Row>
