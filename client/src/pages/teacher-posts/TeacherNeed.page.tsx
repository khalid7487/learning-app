...
import { getAllTeacherPosts } from "./TeacherPosts.service";
...
export default function TeacherNeedPage({ }: Props): ReactElement {
    ...
    const loadData = async (queries: any) => {
        ...
        let res = await getAllTeacherPosts(queries)
    ...
    const onOpenClick = async (item: any) => {
        history.push(`/me/teacher-need-details/${item.id}`)
    }
                                    ...
                                    <Row>
                                        <Col onClick={((event: any) => onOpenClick(item))} sm={2} md={12}>
                                            ...
                                            <div className="d-flex justify-content-between mt-1">
                                                ...
                                                <span className="text-capitalize"><strong className="text-info ">Qualification: </strong> <span className="text-danger">{item?.qualification}</span></span>
                                            </div>
                                            <div className="d-flex justify-content-between mt-1">
                                            ...
                                            <div className="d-flex justify-content-between mt-1">
                                                ...
                                                <span className="text-capitalize"><strong className="text-success ">Designation: </strong> <span className="text-danger">{item?.designation}</span></span>
                                            </div>
                                            ...
                                            <span className="d-flex flex-column  text-capitalize mt-1">
                                                <span><strong className="text-primary">Area You Coverd:</strong> <span className="text-danger">{item?.area_covered}</span> </span>
                                            </span>
